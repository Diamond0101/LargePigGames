<!DOCTYPE html>
    ...
    <strong>Privacy Policy</strong> <p>
                  LargePigGames built this Game as
                  an Ad Supported app. This SERVICE is provided by
                  LargePigGames at no cost and is intended for use as
                  is.
                </p> <p>
                  ...
                  as in our Terms and Conditions, which are accessible below this Privacy Policy.
                  ...
                  Privacy Policy, do not hesitate to contact us at GameDevDiamond@gmail.com.
        
        
       </p> <div><p>  </p> <div><p>
    </p> <p><strong>Terms &amp; Conditions</strong></p> <p>
                  ...
                  to it, still belong to LargePigGames.
                </p> <p>
                  LargePigGames is committed to ensuring that the app is
                  ...
                  LargePigGames will not take responsibility for. Certain
                  functions of the app will require the app to have an active
                  internet connection. The connection can be Wi-Fi or provided
                  by your mobile network provider, but LargePigGames
                  ...
                  Along the same lines, LargePigGames cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service,
                  LargePigGames cannot accept responsibility.
                </p> <p>
                  With respect to LargePigGames’s responsibility for your
                  use of the app, when you’re using the app, it’s important to
                  bear in mind that although we endeavor to ensure that it is
                  updated and correct at all times, we do rely on third parties
                  to provide information to us so that we can make it available
                  to you. LargePigGames accepts no liability for any
                  ...
                  using the app. LargePigGames does not promise that it
